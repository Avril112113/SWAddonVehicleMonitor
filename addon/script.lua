...
local function create_test_vehmon(self)
	...
	function self:setup()
		...
		self.vehmon:SetDBValue(DB_IDXS.COMPANY_NAME, 1, "")
		self.vehmon:DrawText(199, 1, DB_IDXS.MONEY, "$%s")
		self.vehmon:SetDBValue(DB_IDXS.MONEY, 1, 0)
		...
		self.vehmon:SetDBValue(DB_IDXS.PLAYER_POS, {0,0,0})
		self.vehmon:DrawText(1, 14+8+8, DB_IDXS.SERVER_TIME, "server time: %s")
		self.vehmon:SetDBValue(DB_IDXS.SERVER_TIME, 1, 0)
